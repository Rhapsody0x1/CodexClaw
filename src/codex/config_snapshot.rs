...
/// Body of the built-in `claw-cron` skill, materialised into the local Codex
/// home on bootstrap. Kept as a standalone Markdown file so it stays
/// editable/diffable as prose instead of an 80-line raw string literal.
const CRON_SKILL_MD: &str = include_str!("../../assets/skills/claw-cron/SKILL.md");
